...
{
    public partial class frmMedicionM : Form
    {
        double texto1;
        double texto2;
        public frmMedicionM()
        ...
        private void btnResultado_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNum1.SelectedIndex == 0 || cmbNum1.Text.Equals("Gramo"))
            {
                if (cmbNum2.SelectedIndex == 0 || cmbNum2.Text.Equals("Gramo"))
                {
                    texto2 = texto1;
                }
                else
                {
                    if (cmbNum2.SelectedIndex == 1 || cmbNum2.Text.Equals("Kilogramo"))
                    {
                        texto2 = (texto1 * 0.001);
                    }
                    else
                    {
                        if (cmbNum2.SelectedIndex == 2 || cmbNum2.Text.Equals("Toneladas Metricas"))
                        {
                            texto2 = (texto1 * 0.000001);
                        }
                    }
                }
            }
            ...
            {
                if (cmbNum1.SelectedIndex == 1 || cmbNum1.Text.Equals("Kilogramo"))
                {
                    if (cmbNum2.SelectedIndex == 0 || cmbNum2.Text.Equals("Gramo"))
                    {
                        texto2 = (texto1 * 1000);
                ...
                {
                    if (cmbNum1.SelectedIndex == 2 || cmbNum1.Text.Equals("Toneladas Metricas"))
                    {
                        if (cmbNum2.SelectedIndex == 0 || cmbNum2.Text.Equals("Gramo"))
                        {
                            texto2 = (texto1 * 1000000);
                        }
                        else
                        {
                            if (cmbNum2.SelectedIndex == 1 || cmbNum2.Text.Equals("Kilogramo"))
